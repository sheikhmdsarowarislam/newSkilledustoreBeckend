...
const DiscussionSchema = new mongoose_1.Schema({
    ...
    lecture: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Lecture', required: true },
...
const DiscussionModel = mongoose_1.default.model('Discussion', DiscussionSchema);
exports.default = DiscussionModel;
